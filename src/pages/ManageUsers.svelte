...
<div class="flex flex-col items-center  min-h-screen py-10">
    ...
    <div class="w-full max-w-5xl bg-white  overflow-hidden ">
        {#await userPromise}
            <div class="text-center py-10">Loading users...</div>
        {:then users}
            {#if users.length > 0}
                ...
                <table class="table-auto w-full">
                    ...
                    <tr>
                        ...
                        <th class="px-10 py-3 text-center text-stone-400 font-normal tracking-wider"></th>
                        <th class="px-6 py-3 text-center text-stone-400 font-normal tracking-wider ml-10">Is Lead</th>
